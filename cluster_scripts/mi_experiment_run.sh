...
module list
singularity exec -B $PFS_FOLDER/information-leakage-techniques/ --nv $IMG_FILE pipenv run python $SCRIPT_FILE --cindex=$SLURM_JOB_ID --isgpu=0 --schema="mutual_information"
